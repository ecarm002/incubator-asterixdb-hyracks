...
import org.apache.hyracks.dataflow.std.group.external.ExternalGroupMergeOperatorNodePushable;
...
public class ExternalHashGroupbyTest extends AbstractExternalGroupbyTest{
    ...
    ExternalGroupMergeOperatorNodePushable mergeOperator;
    ...
    protected void initial(IHyracksTaskContext ctx, int tableSize, int numFrames) {
        ...
        buildOperator = new ExternalGroupBuildOperatorNodePushable(ctx, this.hashCode(), tableSize, keyFields, numFrames,
                comparatorFactories, normalizedKeyComputerFactory, partialAggrInPlace, inRecordDesc, outputRec, tableFactory);
        mergeOperator = new ExternalGroupMergeOperatorNodePushable(ctx, this.hashCode(), tableFactory, outputRec,
