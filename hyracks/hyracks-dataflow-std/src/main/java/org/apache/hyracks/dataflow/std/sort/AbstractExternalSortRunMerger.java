...
public abstract class AbstractExternalSortRunMerger {
    ...
    public AbstractExternalSortRunMerger(IHyracksTaskContext ctx, ISorter sorter, List<RunAndMaxFrameSizePair> runs,
            IBinaryComparator[] comparators, INormalizedKeyComputer nmkComputer,
            RecordDescriptor recordDesc, int framesLimit, IFrameWriter writer) {
        this(ctx, sorter, runs, comparators, nmkComputer, recordDesc, framesLimit,
