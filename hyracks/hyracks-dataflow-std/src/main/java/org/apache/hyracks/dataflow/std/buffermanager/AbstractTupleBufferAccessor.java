...
public abstract class AbstractTupleBufferAccessor implements ITupleBufferAccessor {
    ...
    public int getTupleStartOffset() {
        return getInnerAccessor().getTupleStartOffset(tid);
    }

    @Override
    public int getTupleLength() {
        return getInnerAccessor().getTupleLength(tid);
    }

    @Override
    public int getAbsFieldStartOffset(int fieldId) {
        return getInnerAccessor().getAbsoluteFieldStartOffset(tid, fieldId);
    }

    @Override
    public int getFieldLength(int fieldId) {
        return getInnerAccessor().getFieldLength(tid, fieldId);
    }
