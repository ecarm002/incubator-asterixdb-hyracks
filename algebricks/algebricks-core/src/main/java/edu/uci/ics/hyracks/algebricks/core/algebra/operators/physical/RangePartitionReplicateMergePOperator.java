...
import edu.uci.ics.hyracks.dataflow.common.data.partition.range.FieldRangePartitionReplicateComputerFactory;
import edu.uci.ics.hyracks.dataflow.common.data.partition.range.IRangeMap;
import edu.uci.ics.hyracks.dataflow.std.connectors.MToNPartitionReplicateMergingConnectorDescriptor;
...
public class RangePartitionReplicateMergePOperator extends AbstractExchangePOperator {
    ...
    public RangePartitionReplicateMergePOperator(List<OrderColumn> partitioningFields, INodeDomain domain, IRangeMap rangeMap) {
    ...
    public Pair<IConnectorDescriptor, TargetConstraint> createConnectorDescriptor(IConnectorDescriptorRegistry spec,
        ...
        ITuplePartitionReplicatorComputerFactory tprcf = new FieldRangePartitionReplicateComputerFactory(sortFields, comps, rangeMap);
        IConnectorDescriptor conn = new MToNPartitionReplicateMergingConnectorDescriptor(spec, tprcf, sortFields, comps, nkcf);
